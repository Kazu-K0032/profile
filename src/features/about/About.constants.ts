...
export const CAREERS: Career[] = [
  ...
  },
  {
    ...
    description:
      "クリニック向けGASを使用した自動化システムの開発。スプレッドシート/GASを使用したメール送信自動化システムの開発。設定したGoogleドライブフォルダにPDFが追加されたとき、設定したアドレス宛に設定したメールを自動送信するシステムを開発。ガントチャートを使用した作業の共有・進捗管理、一連のシステムのGAS開発、業務ヒアリング、要件ヒアリング、課題抽出、シートの変更、顧客へのシステムの説明、動作確認、バグ修正を実施。",
  },
  {
  ...
  },
  {
    ...
    description:
      "内定先企業の営業サポート業務。GASを使用した業務の効率化を中心に活動。エンドクライアント企業のリストアップ/アタック、エンジニア情報と案件情報の自動マッチングシステムの開発、スクレイピングによる複数の就職サイトから必要情報のピックアップシステムの開発、スプレッドシートのセルの更新による自動通知システム、新規エンジニアへの教育を実施。",
  },
  {
