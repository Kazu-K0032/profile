...
export const PRODUCTION_ITEMS: ProductionItem[] = [
      ...
      pages: [
        {
          ...
          content: [
            ...
            "※認証・チャット機能のセキュリティ実装は学習用途のため簡易的です。動作確認の際は、サブアドレス等のご利用を推奨します。",
            "## 背景",
        ...
        },
        {
          ...
          content: [
            ...
            "Udemyで基本機能と簡単なToDoアプリを作成するところまでを2週間で行い、残りの3週間で本アプリを作成しました。終盤はCursorのエージェント機能を活用して開発速度を上げましたが、AI主導で進めた箇所では実装意図の把握が浅くなる場面があり、生成コードを必ず読み解いて自分の理解に取り込む運用ルールの重要性を学びました。最終的に予定していた機能はすべて実装し、Linux学習のため契約していたXサーバーへの自動デプロイとドメイン付きリンクで発表することができました。",
          ],
        },
        {
          title: "【プロジェクトを通した学び】",
  ...
  },
  {
    ...
    description:
      "動画制作の自動化を目的に、掲示板サイト「あにまんch」のスレッドコメントを動画編集ツール「ゆっくりムービーメーカー(YMM)」用の台本形式に変換し、スプレッドシートへ出力するシステムを開発しました。",
      ...
      pages: [
        {
          title: "【プロジェクト概要・開発背景】",
          content: [
            "本プロジェクトでは、掲示板サイト「あにまんch」のスレッドコメントを、動画編集ツール「ゆっくりムービーメーカー(YMM)」用の台本形式に変換し、スプレッドシートへ出力するシステムを開発しました。",
            "趣味でYouTubeの動画制作を行っており、制作プロセスの一部を自動化したいと考え開発に至りました。",
            "",
            "※あにまんch: アニメ・漫画の感想や意見を共有する掲示板サイト",
            "※ゆっくりムービーメーカー(YMM): 動画作成支援ツール",
          ],
        },
        {
          title: "【使用技術・ツール】",
        ...
        },
        {
          ...
          content: [
            ...
            "まず、動画制作の流れをリストアップし、その中でGASを活用できる工程を整理しました。その後、整理した工程に沿って GAS による自動化を進めました。",
          ],
        },
        {
          title: "【プロジェクトを通した学び】",
    ...
    modal: {
      ...
      pages: [
        ...
        },
        {
          ...
          content: [
            "本プロジェクトは、すべての開発工程を一人で担当しました。",
            "初期は最小機能で実装し、自身で利用しながら必要な機能を反復的に追加していくアプローチを取りました。",
          ],
        },
        {
          title: "【プロジェクトを通した学び】",
